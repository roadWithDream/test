...
public class SignatureUtils {
	...
	public static String decryptByPrivateKey(String bizContent, String privateKey) {
		try {
			return new String(SignatureUtils.decryptByPrivateKey(Base64Utils.decode(bizContent), privateKey));
		} catch (Exception e) {
			throw new RuntimeException(e);
		}
	}
	...
	public static String encryptByPublicKey(String request, String publicKey) throws Exception{
		String response = Base64Utils.encode(SignatureUtils.encryptByPublicKey(request.getBytes(), publicKey));
		return response;
	}
