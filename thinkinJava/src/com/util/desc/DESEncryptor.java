...
public class DESEncryptor {
	   ...
	   public DESEncryptor(byte userkey[])
	    {
	        workingKey = null;
	        this.userkey = null;
	    ...
	    public static final String HUNDSUN_VERSION = "@system \u7EFC\u5408\u7406\u8D22\u5E73\u53F0 @version 3.0.0.1 @lastModiDate 20120327 @describe ";
